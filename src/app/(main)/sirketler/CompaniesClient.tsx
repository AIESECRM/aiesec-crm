...
import { CompanySidebar, BulkImportModal } from '@/components/companies';
        ...
        <div className="companies-page__header">
          ...
          <div className="companies-page__actions" style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{ background: 'var(--bg-secondary, #f3f4f6)', color: 'var(--text-primary, #374151)', border: '1px solid var(--border-color, #d1d5db)' }}
