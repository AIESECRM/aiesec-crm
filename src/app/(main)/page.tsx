...
export default async function DashboardPage() {
  ...
  // Sadece normal roller için veri çekiyoruz. National roller için veri ExecutiveDashboard içinde çekiliyor.
  ...
  // Date objelerini serileştirmek için JSON'a çevirip geri parse ediyoruz
