...
export default function RegisterPage() {
  ...
  const handleSubmit = async () => {
    setError("");
    if (!form.name || !form.email || !form.password || !form.chapter) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f9fafb" }}>
      <div style={{ backgroundColor: "white", padding: "32px", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)", width: "100%", maxWidth: "480px" }}>
        ...
        {success && (
          <div style={{ backgroundColor: "#f0fdf4", color: "#16a34a", padding: "12px", borderRadius: "8px", marginBottom: "16px", fontSize: "14px" }}>
            {success}
          </div>
        )}
        ...
        {step === "form" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              <label style={{ display: "block", fontSize: "14px", fontWeight: "500", marginBottom: "4px" }}>Telefon</label>
            ...
            <div>
              <label style={{ display: "block", fontSize: "14px", fontWeight: "500", marginBottom: "4px" }}>Şifre Tekrar *</label>
            ...
            <p style={{ textAlign: "center", fontSize: "14px", color: "#6b7280" }}>
              ...
              <Link href="/login" style={{ color: "#2563eb" }}>Giriş yap</Link>
            </p>
          </div>
        )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              ...
              <input type="text" value={code} onChange={(e) => setCode(e.target.value)} maxLength={6}
                style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: "8px", padding: "12px", fontSize: "24px", fontWeight: "bold", textAlign: "center", letterSpacing: "8px", boxSizing: "border-box" }}
                placeholder="000000" />
            </div>
            ...
            <button onClick={() => { setStep("form"); setError(""); setSuccess(""); }}
              style={{ width: "100%", backgroundColor: "transparent", color: "#6b7280", fontSize: "14px", border: "none", cursor: "pointer" }}>
              ← Geri dön
            </button>
          </div>
        )}
