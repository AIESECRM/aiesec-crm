...
export default async function ContractPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px', fontFamily: 'serif', lineHeight: 1.6 }}>
            ...
            <p>
                İşbu sözleşmenin konusu, Müşteri'nin ihtiyaçları doğrultusunda belirlenen "{proposal.title}" kapsamındaki hizmetlerin (bundan böyle "Hizmet" olarak anılacaktır)
                Hizmet Sağlayıcı tarafından Müşteri'ye sunulmasıdır.
            </p>

            <h3 style={{ fontWeight: 'bold', marginTop: '30px' }}>3. MALİ HÜKÜMLER</h3>
            <p>
                Taraflar, yukarıda belirtilen hizmetin bedeli olarak
                <strong> {proposal.value.toLocaleString('tr-TR')} {proposal.currency}</strong> (+ KDV)
            ...
            {/* A prompt button used just for testing print flow, hidden in CSS print */}
